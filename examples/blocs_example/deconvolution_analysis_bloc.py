...
from pybold.bold_signal import bold_bloc_deconvolution_analysis
...
d = datetime.now()
dirname = ('results_deconvolution_analysis_'
...
t0 = time.time()
res = bold_bloc_deconvolution_analysis(**params)
est_ar_s, est_ai_s, est_i_s, J = res
